import triangleVertex from "./shaders/rotatingCube.vert.wgsl?raw";
import triangleFrag from "./shaders/rotatingCube.frag.wgsl?raw";
...
function draw(device:GPUDevice,pipeline:GPURenderPipeline,context:GPUCanvasContext,vertexObj:any,colorObj:any,depthTexture:GPUTexture){
